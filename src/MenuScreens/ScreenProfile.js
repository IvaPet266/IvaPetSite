      ...
      <div className='CormorantInfant-serif' style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ 
          ...
          <ProfileContents
            ...
            menuSection          ={ menuSection          } activeContentsColor={ "#FFF600"          } 
            inactiveContentsColor={ menuTextColor        } objColor           ={ collectionsColor   } 
            contentsColor        ={ collectionsStrokeSVG } objFillSVG         ={ collectionsFillSVG } 
            lines                ={ lines                } fill               ={ true               }
            w="31" h="31" link="collections" text="Collections" 
          ...
          <ProfileContents
            ...
            setMenuSection       ={ ( state ) => setMenuSection( state    ) } 
            menuSection          ={ menuSection    } activeContentsColor={ "#00BC13"  }  
            inactiveContentsColor={ menuTextColor  } objColor           ={ savedColor } 
            contentsColor        ={ savedStrokeSVG } fill               ={ false      }
            w="28" h="28" link="saved" text="Saved"
          ...
          <ProfileContents
            ...
            menuSection          ={ menuSection    } activeContentsColor  ={ "#B90000"    } 
            inactiveContentsColor={ menuTextColor  } objColor             ={ likedColor   } 
            contentsColor        ={ likedStrokeSVG } objFillSVG           ={ likedFillSVG } 
            fill                 ={ true           } lines                ={ lines        }
            w="28" h="28" link="liked" text="Liked" 
          ...
          <ProfileContents
            ...
            setMenuSection       ={ ( state ) => setMenuSection( state       ) } 
            menuSection          ={ menuSection       } activeContentsColor={ "#4700AA"     }     
            inactiveContentsColor={ menuTextColor     } objColor           ={ repostedColor } 
            contentsColor        ={ repostedStrokeSVG } fill               ={ false         }
            w="24" h="28" link="reposted" text="Reposted" 
          ...
          <ProfileContents
            ...
            setMenuSection       ={ ( state ) => setMenuSection( state       ) } 
            menuSection          ={ menuSection       } activeContentsColor={ bioTextColor  }  
            inactiveContentsColor={ menuTextColor     } objColor           ={ settingsColor } 
            contentsColor        ={ settingsStrokeSVG } fill               ={ false         }
            h="27" w="27" link="settings" text="Settings" 
          ...
          <ProfileContents
            ...
            setMenuSection       ={ ( state ) => setMenuSection( state       ) } 
            menuSection          ={ menuSection       } activeContentsColor={ bioTextColor  }  
            inactiveContentsColor={ menuTextColor     } objColor           ={ privacyPColor } 
            contentsColor        ={ privacyPStrokeSVG } 
            link                 ={ false             } fill               ={ false         }
            w="25" h="25" text="Privacy Policy" 
          ...
          <ProfileContents
            ...
            setMenuSection       ={ ( state ) => setMenuSection( state       ) }
            menuSection          ={ menuSection       } activeContentsColor={ bioTextColor  }  
            inactiveContentsColor={ menuTextColor     } objColor           ={ supportSColor } 
            contentsColor        ={ supportSStrokeSVG } fill               ={ false         }
            w="25" h="25" link="support" text="Support Service" 
          ...
          <ProfileContents
            ...
            setMenuSection       ={ ( state ) => setMenuSection( state     ) } 
            menuSection          ={ menuSection     } activeContentsColor={ bioTextColor }
            inactiveContentsColor={ menuTextColor   } objColor           ={ logOutColor  }  
            contentsColor        ={ logOutStrokeSVG }
            link                 ={ false           } fill               ={ false        }
            w="25" h="25" text="Log Out"
