  ...
  return (
    <nav>
      <div id="menu" style={{
          ...
          height: "100px", border: `solid ${ lines } 1px` 
        }}>
        <div>
          <NavLink to="/">
            { ({ isActive }) => (
              <Button id="main" isActive={ isActive } >Main</Button>
            )}
          </NavLink>
          <NavLink to="/contests">
            { ({ isActive }) => (
              <Button id="contests" isActive={ isActive }>Contests</Button>
            )}
          </NavLink>
          <NavLink to="/discussion">
            { ({ isActive }) => (
              <Button id="discussion" isActive={ isActive }>Discussion</Button>
            )}
          </NavLink>
        </div>  
        <NavLink to="/newpost">
          { ({ isActive }) => (
            <SVGButton2Paths id="newpost" isActive={ isActive }
        ...
        <div>  
          <SVGButton menu={ true } id="search" w="58" h="58" 
          ...
          />
          <SVGButton menu={ true } id="profile" w="52" h="58" 
