      ...
      <div className='CormorantInfant-serif' style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ 
          ...
          <ProfileContents
            ...
            activeContentsColor={ "#00BC13" } inactiveContentsColor={ menuTextColor } link={ true }
          ...
          <ProfileContents
            ...
            activeContentsColor={ "#4700AA" } inactiveContentsColor={ menuTextColor } link={ true }
          ...
          <ProfileContents
            ...
            activeContentsColor={ bioTextColor } inactiveContentsColor={ menuTextColor } link={ true }
