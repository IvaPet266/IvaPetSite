    ...
    <div 
      ...
      <button style={{ background: "transparent", border: "none", margin: "0px", padding: "2px" }}>
        <span className='CormorantInfant-serif' 
          style={{ pointerEvents: "none", transition: "color 300ms ease-out", fontWeight: "bold", color: props.objColor, fontSize: "25px" }}>
          { props.text }
        </span>
      </button>
      <svg 
        style={{ 
          transition: "all 300ms ease-out", pointerEvents: "none", margin: "0px", paddingRight: "5px",
          alignSelf: "center" 
        }} width={ props.w } height={ props.h } viewBox={`0 0 ${ props.w } ${ props.h }`} fill="none" xmlns="http://www.w3.org/2000/svg">
        <path style={{ 
          transition: "stroke 300ms ease-out", stroke: props.contentsColor, strokeWidth: "3", strokeLinecap: "round", strokeLinejoin: "round" }}
          d={ props.d }
        />
        {props.d1 && <path style={{
          transition: "stroke 300ms ease-out", stroke: props.contentsColor, strokeWidth: "3", strokeLinecap: "round", strokeLinejoin: "round" }}
    ...
    <div 
      ...
      <svg 
        style={{ 
          transition: "all 300ms ease-out", pointerEvents: "none", margin: "0px", paddingRight: "5px",
          alignSelf: "center" 
        }} width={ props.w } height={ props.h } viewBox={`0 0 ${ props.w } ${ props.h }`} fill={ props.objFillSVG } xmlns="http://www.w3.org/2000/svg">
        <path style={{ 
          transition: "stroke 300ms ease-out", stroke: props.contentsColor, strokeWidth: "3", strokeLinecap: "round", strokeLinejoin: "round" }}
          d={ props.d }
        />
      ...
      return (
        <div style={{ width: "80%", height: "100vh", display: "flex", flexDirection: "column", alignItems: "center", marginTop: "5px" }}>
          ...
          <div style={{ width: "80%", display: "flex", flexDirection: "row", padding: "0px", justifyContent: "space-between" }}>
            ...
            <input id="colorThemeInput" type="color" value={ inputValue } onChange={ ( event ) => setInputValue( event.target.value ) } 
              style={{ border: "solid 1px black", backgroundColor: "transparent", width: "80px", height: "50px" }}/>
          </div>
          <button style={{ 
            transition: "all 300ms ease-out", border: "none", 
            backgroundColor: "transparent", color: confirmColor 
...
export function Lines( props ) {
  return (
    <div style={{ width: "40%", display: "flex", flexDirection: "column" }}>
      <hr style={{ border: "none", margin: "2.5px", width: "100%", backgroundColor: props.bg }} size="3"/>
      <hr style={{ border: "none", margin: "2.5px", width: "100%", backgroundColor: props.bg }} size="3"/>
    </div>
  )
}