      ...
      <div className='CormorantInfant-serif' style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ 
          ...
          <ProfileContents
            ...
            w="31" h="31" lines={ lines } link="collections" text="Collections" fill={ true }
          ...
          <ProfileContents
            ...
            objColor           ={ savedColor } contentsColor        ={ savedStrokeSVG } 
            w="28" h="28" link="saved" text="Saved" fill={ false }
          ...
          <ProfileContents
            ...
            w="28" h="28" lines={ lines } link="liked" text="Liked" fill={ true }
          ...
          <ProfileContents
            ...
            objColor           ={ repostedColor } contentsColor        ={ repostedStrokeSVG } 
            w="24" h="28" link="reposted" text="Reposted" fill={ false }
          ...
          <ProfileContents
            ...
            objColor           ={ settingsColor } contentsColor        ={ settingsStrokeSVG } 
            h="27" w="27" link="settings" text="Settings" fill={ false }
          ...
          <ProfileContents
            ...
            menuSection        ={ menuSection } 
            activeContentsColor={ bioTextColor }  inactiveContentsColor={ menuTextColor } 
            objColor           ={ privacyPColor } contentsColor        ={ privacyPStrokeSVG } 
            w="25" h="25" link={ false } text="Privacy Policy" fill={ false }
          ...
          <ProfileContents
            ...
            menuSection        ={ menuSection } 
            activeContentsColor={ bioTextColor }  inactiveContentsColor={ menuTextColor } 
            objColor           ={ supportSColor } contentsColor        ={ supportSStrokeSVG } 
            w="25" h="25" link="support" text="Support Service" fill={ false }
          ...
          <ProfileContents
            ...
            menuSection        ={ menuSection } 
            activeContentsColor={ bioTextColor } inactiveContentsColor={ menuTextColor } 
            objColor           ={ logOutColor }  contentsColor        ={ logOutStrokeSVG } 
            w="25" h="25" link={ false } text="Log Out" fill={ false }
